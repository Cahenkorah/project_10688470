...
public:
    ...
    //getters to get the various values of courses
public:
...
public:
    void setStaff(sring name,string id){
    staffName = name;
    staffID = id;
    }
public:
...
int main()
{
    ...
    newCourse[0].setCourse("Calculus_1","MATH122 ");
    newCourse[1].setCourse("Numerical_Method", "CSCD207");
    newCourse[2].setCourse("Computer_Hardware_And_Architecture","CSCD211");
    newCourse[3].setCourse("Information_Systems","CSCD201");
    newCourse[4].setCourse("Vectors_And_Geometry","MATH123");

    Staff newStaff[10];
    newStaff[0].setStaff("Mr. James Ato","10001");
    newStaff[1].setStaff("Mr.Solomon Boateng","10002");
    newStaff[2].setStaff("Mr. Enoch Asare","10003");
    newStaff[3].setStaff("Mrs. Eunice Agyeiwaa","10004");
    newStaff[4].setStaff("Mr. Kwadwo Appiah","10005");
